...
import { Errored, createMemo } from "solid-js";

// Cancellation-style helper: rejects with no value, like a request that was
// superseded / aborted. Any nullish rejection (reject(), reject(null)) hits this.
